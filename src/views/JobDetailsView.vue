...
const job = computed(() => route.params.job ? JSON.parse(decodeURIComponent(route.params.job as string)) as JobPosting : null)
    ...
    <div v-if="job" class="py-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 sm:p-8">
            ...
            <div class="prose dark:prose-invert max-w-none mb-8">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Job Description</h3>
                <p class="whitespace-pre-line text-gray-700 dark:text-gray-300">{{ job.description }}</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Required Skills</h3>
